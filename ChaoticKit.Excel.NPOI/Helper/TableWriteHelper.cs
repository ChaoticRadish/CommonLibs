using ChaoticKit.Module.Mission;
...
namespace ChaoticKit.Excel.NPOI.Helper
{
    public class TableWriteHelper : IDisposable, IProgressMission
    {
        ...
        private string GetSummaryString(ColumnOption option, List<object?> values)
        {
            ...
            string resultEzCheck = ChaoticKit.String.StringAnalysis.AnalysisToStringForPair(
            ...
            // 格式化
            return ChaoticKit.String.StringAnalysis.AnalysisToStringForPair(
                   option.SummaryStringFormat,
                   (source) =>
                   {
                       if (!string.IsNullOrEmpty(source))
