...
namespace ChaoticKit.Extensions
{
    public static class StringExtensions
    {
        ...
        public static IEnumerable<string> SplitIgnoreStringValue(this string input, char delimiter, 
            ...
            => ChaoticKit.String.StringAnalysis.SplitIgnoreStringValue(input, delimiter, splitOptions);
        ...
        public static int IndexOfIgnoreStringValue(this string input, char value)
            => ChaoticKit.String.StringAnalysis.IndexOfIgnoreStringValue(input, value);
        ...
        public static int LastIndexOfIgnoreStringValue(this string input, char value)
            => ChaoticKit.String.StringAnalysis.LastIndexOfIgnoreStringValue(input, value);
        #endregion
    }
}
