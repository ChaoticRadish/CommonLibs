...
namespace ChaoticKit.Data.Struct
{
    ...
    public struct CollectionResult<TItem, TExtra> : IOperationResult, ICollectionResult<TItem>
    {
        ...
        /// <summary>
        /// 断言操作结果数据 <see cref="Extra"/> 不可能是 <see langword="null"/>, 如果出现了 <see langword="null"/>, 则抛出 <see cref="ChaoticKit.Exceptions.General.ImplementationException"/>
        /// </summary>
        ...
        {
            if (Extra == null) throw new ChaoticKit.Exceptions.General.ImplementationException($"{(extreDesc ?? "附带数据")}此处不应该是 null 值");
        }
