...
using ChaoticKit.Wpf.Attributes;

namespace ChaoticKit.Wpf.Themes
{
    public static class ColorManager
    {
        ...
        private static string _FullColorFileName(string fileName) => $"pack://application:,,,/ChaoticKit.Wpf;component/Themes/ColorGroups/{fileName}";
    }
}
