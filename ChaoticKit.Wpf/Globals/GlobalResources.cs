...
namespace ChaoticKit.Wpf.Globals
{
    /// <summary>
    /// 通用资源管理类, 管理 ChaoticKit.Wpf 内需要被用到的通用资源
    /// </summary>
    public static class GlobalResources
    {
        ...
        private static string _fullFileName(string fileName) => $"pack://application:,,,/ChaoticKit.Wpf;component/Globals/{fileName}";
        #endregion
