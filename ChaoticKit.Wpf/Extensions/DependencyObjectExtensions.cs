...
namespace ChaoticKit.Wpf.Extensions
{
    public static class DependencyObjectExtensions
    {
        ...
        /// <returns></returns>
        public static T? GetFirstChildObject<T>(this DependencyObject obj) where T : FrameworkElement
        {
        ...
        /// <summary>
        /// 查找第一个类型, 名字, 均与输入值匹配的子控件
        /// </summary>
        /// <typeparam name="T"></typeparam>
        /// <param name="obj"></param>
        /// <param name="name"></param>
        /// <returns></returns>
        public static T? GetFirstChildObject<T>(this DependencyObject obj, string? name) where T : FrameworkElement
        {
            if (obj == null) return null;
