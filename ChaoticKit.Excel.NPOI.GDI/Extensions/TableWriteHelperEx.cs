using ChaoticKit.Excel.NPOI.Helper;
using ChaoticKit.GDI.Images;
...
namespace ChaoticKit.Excel.NPOI.GDI.Extensions
{
        ...
        private struct _setValueExImplBody(TableWriteHelper.SetValueExtensionContext context)
        {
                ...
                Func<int, System.Drawing.Image?> beforeSet, Action<int>? afterSet)
            {
                ...
                for (int i = 0; i < count; i++)
                {
                    ...
                    totalWidth += gapWidth;
                    // 在单元格中的尺寸
                    System.Drawing.Size size = ChaoticKit.Maths.SizeCalcUtil.ZoomToHeight(image.Size, (int)(cellHeight - gapWidth * 2));
