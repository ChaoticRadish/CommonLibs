...
using ChaoticKit.Attributes;
using ChaoticKit.Extensions;
using ChaoticKit.Winform.Attributes;
using ChaoticKit.Winform.Pages;
using ChaoticKit.Winform.Pages.Layout;
using System;
...
using ChaoticKit.Winform.Controls.Menus;
    ...
    public partial class MainFormTemplate01 : FormEx01
    {
        ...
        protected virtual void LoadProperty_TopMenu()
        {
            ...
            menuItemTree.SortChildrenUse(
                (node1, node2) =>
                {
                    return node1.NodeScope > node2.NodeScope ? ChaoticKit.Enums.CompareResultEnum.Bigger : ChaoticKit.Enums.CompareResultEnum.Smaller;
                });
