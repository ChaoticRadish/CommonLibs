using ChaoticKit.GDI;
using ChaoticKit.Winform.Enums;
using System;
...
namespace ChaoticKit.Winform.Controls
{
    /// <summary>
    /// 简易状态的Label
    /// </summary>
    [DefaultEvent(nameof(Click))]
    public class LabelSimpleState01 : UserControl
    {
        public LabelSimpleState01() 
        {
            DoubleBuffered = true;
        }

        [Category("CVII_自定义"), DisplayName("当前状态")]
        public SimpleStateEnum State 
        {
            get => _state;
            set
            {
        ...
        private SimpleStateEnum _state = SimpleStateEnum.UnChecked;
        ...
        public new Color BackColor
        {
            get
            {
                return State switch
                {
                    SimpleStateEnum.Checked => StateBackColor_Checked,
                    SimpleStateEnum.UnChecked => StateBackColor_UnChecked,
                    SimpleStateEnum.ReadOnly => StateBackColor_ReadOnly,
                    SimpleStateEnum.Disable => StateBackColor_Disable,
                    _ => Color.White,
                };
            }
        }
        ...
        public new Color ForeColor
        {
            get
            {
                return State switch
                {
                    SimpleStateEnum.Checked => StateForeColor_Checked,
                    SimpleStateEnum.UnChecked => StateForeColor_UnChecked,
                    SimpleStateEnum.ReadOnly => StateForeColor_ReadOnly,
                    SimpleStateEnum.Disable => StateForeColor_Disable,
                    _ => Color.White,
                };
            }
        }
        ...
        {
            if (State == SimpleStateEnum.Disable) return;
            base.OnClick(e);
        }
        #endregion
    }
