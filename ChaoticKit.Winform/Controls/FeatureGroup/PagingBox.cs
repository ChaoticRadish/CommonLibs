...
namespace ChaoticKit.Winform.Controls.FeatureGroup
{
    /// <summary>
    /// 分页控件
    /// </summary>
    ...
    public partial class PagingBox : UserControl
    {
        ...
        private void PageInput_ValueChanged(ChaoticKit.Winform.Controls.ValueBox.IntegerBox inputBox, int oldValue, int newValue)
        {
