...
namespace ChaoticKit.LibTest.Console.Text
{
    internal class Escape001() : TestBase("测试 EscapeHelper 及实现过程中的一些代码")
    {
        ...
        private void test2(string input)
        {
            ...
            t1 = t1.Insert(System.Random.Shared.Next(t1.Length), "1");
            t1 = t1.Insert(System.Random.Shared.Next(t1.Length), "2");
            t1 = t1.Insert(System.Random.Shared.Next(t1.Length), "3");
