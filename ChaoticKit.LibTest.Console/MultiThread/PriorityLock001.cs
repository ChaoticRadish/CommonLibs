using ChaoticKit.Module.Concurrency;
using System;
...
namespace ChaoticKit.LibTest.Console.MultiThread
{
    internal class PriorityLock001() : TestBase("测试释放优先的锁 ReleasePriorityLock")
    {
        ...
        {
            System.Console.WriteLine("全面测试 ReleasePriorityLock 的释放优先机制");
            System.Console.WriteLine("=================================================");
            System.Console.WriteLine("测试场景包括:");
            System.Console.WriteLine("1. 基础创建/释放操作");
            System.Console.WriteLine("2. 多个释放请求排队");
            System.Console.WriteLine("3. 创建操作中的高并发压力");
            System.Console.WriteLine("4. 创建操作中的异常情况");
            System.Console.WriteLine("5. 长时间创建操作");
            System.Console.WriteLine("6. 混合操作（创建/释放交错）");
            System.Console.WriteLine("7. 资源计数正确性");
            System.Console.WriteLine("8. 对象释放后操作");
            System.Console.WriteLine("=================================================\n");
